        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="well col-sm-12">
                    ...
                    {!! Form::open(['action'=>['AssumptionsController@update',$assumption->id], 'method'=>'POST']) !!}
                    @csrf
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {{Form::text('name',$assumption->name, ['class' => 'form-control', 'placeholder' => 'Assumption name'])}}
                    </div>
                    <div class="form-group col-sm-6">
                        {{Form::label('owner', 'Assumption owner')}}
                        {{Form::text('owner',$assumption->owner, ['class' => 'form-control', 'placeholder' => 'owner'])}}
                    </div>
                    <div class="form-group col-sm-6">
                        {{Form::label('reason', 'Reason for assumption')}}
                        {{Form::textarea('reason', $assumption->reason, ['class' => 'form-control', 'placeholder' => 'reason'])}}
                    </div>
                    <div class="form-group col-sm-6">
                        {{Form::label('validation', 'How to validate')}}
                        {{Form::textarea('validation', $assumption->validation, ['class' => 'form-control', 'placeholder' => 'validate'])}}
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {{Form::textarea('description', $assumption->description, ['class' => 'form-control', 'placeholder' => 'description'])}}
                    </div>
                    <div class="form-group col-sm-6">
                        {{Form::label('response', 'Response Strategy')}}
                        {{Form::textarea('response', $assumption->response, ['class' => 'form-control', 'placeholder' => 'Response strategy'])}}
                    </div>
