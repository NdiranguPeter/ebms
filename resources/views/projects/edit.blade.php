                ...
                <div class="well col-sm-12">
                    <div class=" col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::text('irw_pin', $project->irw_pin, ['class' => 'form-control', 'placeholder' => 'Project irw_pin'])}}
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::date('start', $project->start, ['class' => 'form-control', 'placeholder' => 'Start date'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('end', 'End date')}}
                            {{Form::date('end', $project->end, ['class' => 'form-control', 'placeholder' => 'End date'])}}
                        </div>

                        <div class="form-group" id="field">
                            {{Form::label('location', 'Location')}}
                            {{Form::text('location', $project->location, ['class' => 'form-control', 'placeholder' => 'Actual location the project is conducted'])}}
                        </div>
                        <div class="form-group">
