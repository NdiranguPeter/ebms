    ...
    <div class="well col-sm-12">
        <div class=" col-sm-6">
            ...
            <div class="form-group">
                ...
                <select name="partners[]" id="" class="form-control multiselect" multiple="multiple" role="multiselect">
                    @if (count($partners)>0)
            ...
            <div class="form-group">
                ...
                <select name="ir_office" id="ir_office" class="form-control @error('ir_office') is-invalid @enderror">
            ...
            <div class="form-group">
                ...
                <select name="donors[]" id="" class="form-control multiselect" multiple="multiple" role="multiselect">
                    @if (count($donors)>0)
