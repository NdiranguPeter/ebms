            ...
            <div class="container-fluid">
                ...
                <div class="well col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('name', $partner->name, ['class' => 'form-control', 'placeholder' => 'name'])}}
                    </div>

                    <div class="form-group">
                        {{Form::label('acronym', 'Acronym')}}
                        {{Form::text('acronym',$partner->acronym, ['class' => 'form-control', 'placeholder' => 'Acronym'])}}
                    </div>


                    <div class="form-group">
                        {{Form::label('email', 'Email')}}
                        {{Form::email('email', $partner->email, ['class' => 'form-control', 'placeholder' => 'Email'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('type', 'Type')}}
                        <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">

                            <option value={{$partner->type}} selected> {{$partner->type}} </option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                            <option value={{$partner->role}} selected> {{$partner->role}} </option>
                    ...
                    <div class="form-group">
                        ...
                        {{Form::number('phone', $partner->phone, ['class' => 'form-control', 'placeholder' => 'phone'])}}
                    </div>

                    <div class="form-group">
                        {{Form::label('address', 'Address')}}
                        {{Form::text('address', $partner->address, ['class' => 'form-control', 'placeholder' => 'Address'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('description', 'Description')}}
                        {{Form::textarea('description', $partner->description, ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'description'])}}
                    </div>
